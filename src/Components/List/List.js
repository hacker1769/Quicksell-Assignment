                    ...
                    {
                        {
                            ...
                            'priority' : <>{
                                {
                                    0: <div className="card-tag-icon"></div>,
                                    1: <div className="card-tag-icon"></div>,
                                    2: <div className="card-tag-icon"></div>,
                                    3: <div className="card-tag-icon"></div>,
                                    4: <div className="card-tag-icon"></div>
                                }[props.listTitle]
                            } </>
                        }[props.groupValue]
                    }
